...
public class LoginActivity extends AppCompatActivity {
    ...
    private void createSpinner() {
        ...
        ArrayAdapter<String> objArrayAdapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, strProvinceArray);
        provinceSpinner.setAdapter(objArrayAdapter);
    ...
    public void clickLogin(View view) {
        ...
        if (idCardString.equals("")  || passwordString.equals("")) {
            ...
            objMyAlertDialog.errorDialog(LoginActivity.this,"Error","กรุณาใส่ข้อมูลให้ครบ");
